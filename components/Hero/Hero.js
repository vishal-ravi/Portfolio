...
const Hero = () => {
    ...
    >
      ...
      <div className="flex flex-col pt-40 md:pt-0 select-none">
        ...
        <h1 className={`${styles.heroName} text-white text-6xl font-semibold`}>
          <span className={`relative ${styles.emphasize} seq`}>Vishal</span>
          <span className="seq"> Ravi</span>
        </h1>
        <p>
          <span
            ref={typedEl}
  ...
  <Button href="https://drive.google.com/file/d/1Y_z6V530mIhi1JF-BScV4LqMglcBQET8/view" classes="link" type="primary">
    Resume
  </Button>
</div>
