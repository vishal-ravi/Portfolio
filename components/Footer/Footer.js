...
const Footer = () => {
  ...
  return (
    <footer
      ...
      style={{
        backgroundImage: `linear-gradient(to right, ${theme.colors.indigo.light}, ${theme.colors.dark})`,
      }}
    >
      {/* <FooterBg /> */}
        ...
        <div className="w-full h-full pt-32">
          <div className="section-container flex flex-col h-full justify-end z-10 items-center py-12">
            ...
            <div className="seq pt-4">
              <Button href="mailto:vishalravi294@gmail.com" classes="link" type="primary">
                Let&apos;s Talk
              </Button>
            </div>
            ...
            <p className="text-center text-white text-sm sm:text-base font-medium tracking-wide mt-8">
              ...
              by <span className="text-white">Vishal Ravi </span>
            </p>
          </div>
        </div>
      </Fade>
